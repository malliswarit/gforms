...
const PieChartDemo = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div>
                <Chart type="pie" data={question1} options={options} style={{ position: 'relative', width: '30%'}} />
            </div>
            <h1>Entomology is the science that studies ? </h1>
            <div className="card flex justify-content-center">
                <Chart type="pie" data={question2} options={options} style={{ position: 'relative', width: '30%' }} />
            </div>
            <h1>Eritrea, which became the 182nd member of the UN in 1993, is in the continent of ? </h1>
            <div className="card flex justify-content-center">
                <Chart type="pie" data={question3} options={options} style={{ position: 'relative', width: '30%' }} />
            </div>
            <h1>Garampani sanctuary is located at ? </h1>
            <div className="card flex justify-content-center">
                <Chart type="pie" data={question4} options={options} style={{ position: 'relative', width: '30%' }} />
            </div>
        </React.Fragment>
